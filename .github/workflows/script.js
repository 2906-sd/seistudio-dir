...
function refreshWotd() {
   ...
   document.getElementById("wotdDefinition").textContent = entry.definition;
    ...
    "popup-modal": {
     ...
     blurb:
      "Is your site catered to adults? Does it has some stuff that requires an advisory warning? Or maybe you need a quick message to visitors about new site changes or something? A pop up modal can do that for you. You had to click through one when you first visited this place! A pop up modal is an overlay that sits on top of the entire page and blocks everything underneath until it's dismissed. It's the same core recipe as any auto-show pop-up: <b>display: flex</b> to show, <b>display: none</b> to hide, an <b>overflow: hidden</b> class on the <b>&lt;body&gt;</b> to lock scrolling behind it, and a simple <b>function</b> to dismiss it. Hit the button above to preview mine, then I’ll walk you through how build the same thing from scratch so you can swap in your own message.",
     sections: [
      {
       label: "Step 1: The HTML",
       note:
